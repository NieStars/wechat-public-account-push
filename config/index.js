export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx799524869a711279",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "e1c4091453016ceb05a263ccf024c208",
  ...
  USERS: [
    {
      ...
      id: "oQuGB6o78-hmAYGtJFOzn4hdC--M",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "FIhxFMvqsIDqcd21KTAvQSHw7mW0gjerdCqDZ1TDY6Y",
      // 所在省份
      province: "重庆",
      // 所在城市
      city: "重庆",
      ...
      festivals: [
        ...
        {"type": "生日", "name": "聂星星", "year": "1999", "date": "10-19"},
